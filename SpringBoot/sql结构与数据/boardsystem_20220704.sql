...
INSERT INTO `equipmentgroup` VALUES ('2', 'TESTn101', 'zju', '2', 'GZJisZLGsHandsbend', null);
...
INSERT INTO `notice` VALUES ('7', null, 'testUpdate', '发布中', 'admin2', '2022-10-01 10:00:08', '2022-10-01 10:00:08', '2022-11-01 10:00:08', '持续播放', '快', '上', 'FFFF0', '5', 'FFFFF', '10', '[2, 3, 4]');
INSERT INTO `notice` VALUES ('8', null, 'testUpdate', '发布中', 'admin2', '2022-10-01 10:00:08', '2022-10-01 10:00:08', '2022-11-01 10:00:08', '持续播放', '快', '上', 'FFFF0', '5', 'FFFFF', '10', '[2, 3, 4]');
INSERT INTO `notice` VALUES ('9', null, 'test', '发布中', 'admin2', '2022-07-04 10:59:24', '2022-10-01 10:00:08', '2022-11-01 10:00:08', '时段播放', '快', '上', 'FFFFF0', '5', 'FFFFFF', '10', '[6]');
...
CREATE TABLE `plan` (
  `planID` int(11) NOT NULL AUTO_INCREMENT COMMENT '计划ID',
  ...
  `planContent` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '计划内容',
  `equipmentList` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '设备列表',
  `playbackList` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '播放内容Json',
...
-- Records of plan
-- ----------------------------
INSERT INTO `plan` VALUES ('2', 'updateTest', 'url', '发布中', '持续播放', null, null, 'test2', 'SuperAdmin', '2022-07-04 10:29:49', '[{\"programID\":2}]', '[5]', null, null, null);
INSERT INTO `plan` VALUES ('3', 'testPlan', 'url', '发布中', '持续播放', null, null, 'test2', null, '2022-07-04 09:20:31', '[{\"programID\":1}]', '[6]', null, null, null);
INSERT INTO `plan` VALUES ('4', 'testPlan', 'url', '发布中', '持续播放', null, null, 'admin2', 'SuperAdmin', '2022-07-04 09:22:27', '[{\"programID\":1}]', '[6]', null, null, null);
INSERT INTO `plan` VALUES ('5', 'testPlan', 'url', '发布中', '持续播放', null, null, 'admin2', 'SuperAdmin', '2022-07-04 15:38:27', '[{\"programID\":1}]', '[5]', null, null, null);
INSERT INTO `plan` VALUES ('6', 'testPlan', 'url', '发布中', '时段播放', '2021-10-01 00:00:00', '2022-01-28 00:00:00', 'admin2', 'SuperAdmin', '2022-07-04 15:38:52', '[{\"programID\":1}]', '[5]', null, '09:09:09', '19:09:09');
